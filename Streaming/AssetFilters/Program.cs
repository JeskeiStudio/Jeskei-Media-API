...
// Creating a unique suffix so that we don't have name collisions if you run this
    ...
    var transform = await mediaServicesAccount.GetMediaTransforms().CreateOrUpdateAsync(
       ...
       new MediaTransformData
       {
           Outputs =
           {
               ...
               (
                   // The preset for the Transform is set to one of Media Services built-in presets.
                   // You can  customize the encoding settings by changing this to use "StandardEncoderPreset" class.
                   preset: new BuiltInStandardEncoderPreset(
                       // This uses the built-in encoding preset for Adaptive Bit-rate Streaming.
